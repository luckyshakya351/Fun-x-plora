...
function FundAddToUser() {
  ...
  const addbankDetailsFunction = async (fd) => {
    setloding(true);
    try {
      const response = await axios.post(`${endpoint.add_fund_to_user}`, fd);
          ...
          >
            ...
            <Box mt={2}>
              ...
              <FormControl fullWidth sx={{ mt: "10px" }}>
                <Stack direction="row" className="loginlabel">
                  <Typography variant="h3" sx={{ color: "white" }}>
                    Working Wallet <span className="!text-red-600">*</span>
                  </Typography>
                </Stack>
                <p className="withdrawalfield2 !text-white ">
                  {user_data?.working_wallet}
                </p>
              </FormControl>
              <FormControl fullWidth sx={{ mt: "10px" }}>
                <Stack direction="row" className="loginlabel">
                  <Typography variant="h3" sx={{ color: "white" }}>
                    Main Wallet <span className="!text-red-600">*</span>
                  </Typography>
                </Stack>
                <p className="withdrawalfield2 !text-white ">
                  {user_data?.wallet}
              ...
              <FormControl fullWidth sx={{ mt: "10px" }}>
                <Stack direction="row" className="loginlabel">
                  <Typography variant="h3" sx={{ color: "white" }}>
                    Winning Wallet <span className="!text-red-600">*</span>
                  </Typography>
                </Stack>
                <p className="withdrawalfield2 !text-white ">
                  {user_data?.winning_wallet}
                </p>
              </FormControl>
