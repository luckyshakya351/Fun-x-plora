...
import { promotionDataFunctionNodeJs } from "../../../services/apicalling";
function TeamData() {
  ...
  const levelOneWithDeposit = result?.filter(
    (level) => level.LEVEL === 1 && Number(level.deposit_amount) > 0
  );
  const total_deposit = levelOneWithDeposit?.reduce(
  ...
  const levelTwoWithDeposit = result?.filter(
    (level) => level.LEVEL === 2 && Number(level.deposit_amount) > 0
  );
  const to_deposit = levelTwoWithDeposit?.reduce(
    (a, b) => a + Number(b?.deposit_amount || 0),
    0
  );
  ...
  const level3WithDeposit = result?.filter(
    (level) => level.LEVEL === 3 && Number(level.deposit_amount) > 0
  );
  const three_deposit = level3WithDeposit?.reduce(
    (a, b) => a + Number(b?.deposit_amount || 0),
    0
  );
  ...
  const level4WithDeposit = result?.filter(
    (level) => level.LEVEL === 4 && Number(level.deposit_amount) > 0
  );
  const four_deposit = level4WithDeposit?.reduce(
    (a, b) => a + Number(b?.deposit_amount || 0),
    0
  );
  ...
  const level5WithDeposit = result?.filter(
    (level) => level.LEVEL === 5 && Number(level.deposit_amount) > 0
  );
  const five_deposit = level5WithDeposit?.reduce(
    (a, b) => a + Number(b?.deposit_amount || 0),
    0
  );
  ...
  const level6WithDeposit = result?.filter(
    (level) => level.LEVEL === 6 && Number(level.deposit_amount) > 0
  );
  const Six_deposit = level6WithDeposit?.reduce(
    (a, b) => a + Number(b?.deposit_amount || 0),
    0
  );
            ...
            <Accordion className="!rounded-lg">
              ...
              >
                <div className="w-full grid grid-cols-3 pr-2">
                  ...
                  <p className="">
                    {rupees}{" "}
                    <span className="text-green-200">{total_deposit || 0}</span>{" "}
                  </p>
                </div>
              </AccordionSummary>
              <AccordionDetails
                  ...
                  <Box sx={style.accordian}>
                    ...
                    {level1Data?.map((i, index) => {
                      return (
                        ...
                        >
                          <span>{index + 1}</span>
                          <span className=" ">{i?.id || "No data found"}</span>
                          <span className=" ">
            ...
            <Accordion className="!rounded-lg">
              ...
              >
                <div className="w-full grid grid-cols-3 pr-2">
                  ...
                  <p className="">
                    {rupees}{" "}
                    <span className="text-green-200">{to_deposit || 0}</span>{" "}
                  </p>
                </div>
              </AccordionSummary>
              <AccordionDetails
            ...
            <Accordion className="!rounded-lg">
              ...
              >
                <div className="w-full grid grid-cols-3 pr-2">
                  ...
                  <p className="">
                    {rupees}{" "}
                    <span className="text-green-200">{three_deposit || 0}</span>{" "}
                  </p>
                </div>
              </AccordionSummary>
              <AccordionDetails
            ...
            <Accordion className="!rounded-lg">
              ...
              >
                <div className="w-full grid grid-cols-3 pr-2">
                  ...
                  <p className="">
                    {rupees}{" "}
                    <span className="text-green-200">{four_deposit || 0}</span>{" "}
                  </p>
                </div>
              </AccordionSummary>
              <AccordionDetails
            ...
            <Accordion className="!rounded-lg">
              ...
              >
                <div className="w-full grid grid-cols-3 pr-2">
                  ...
                  <p className="">
                    {rupees}{" "}
                    <span className="text-green-200">{five_deposit || 0}</span>{" "}
                  </p>
                </div>
              </AccordionSummary>
              <AccordionDetails
            ...
            <Accordion className="!rounded-lg">
              ...
              >
                <div className="w-full grid grid-cols-3 pr-2">
                  ...
                  <p className="">
                    {rupees}{" "}
                    <span className="text-green-200">{Six_deposit || 0}</span>{" "}
                  </p>
                </div>
              </AccordionSummary>
              <AccordionDetails
