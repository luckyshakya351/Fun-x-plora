  ...
  return (
    <Layout>
      ...
      >
        ...
        >
          <Box
            className="!border text-gray-500  !w-1/2 !p-2 !flex !justify-between"
        ...
        {data?.map((item) => {
          return (
            <div className="flex flex-col justify-center gap-1 mt-10 !mb-20 m-2">
        ...
        <div className={`drawer ${isOpen1 ? "open" : ""} !pb-20 px-1`}>
          <div className="!flex flex-col justify-between my-5">
            ...
            <div className="!flex justify-between px-5">
              <p className="!cursor-pointer" onClick={toggleDrawer1}>
                Cancel
              </p>
              <p
